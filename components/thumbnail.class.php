...
#
# size_square() implemented by Cristòfol Torrens
# 22 June 2009
# piffall_at_gmail.com
# http://piffall.com
############################################
...
$thumb->size_square(80);				// set centered square for thumbnail
...
class thumbnail
{
	...
	function size_square($size=80)
    {
        if (@$this->img["lebar"]>=@$this->img["tinggi"]) {
            @$this->img["x"] = ceil((@$this->img['lebar']-@$this->img['tinggi'])/2);
            @$this->img["lebar"] = @$this->img["tinggi"];
			@$this->img["lebar_thumb"]= $size;
            @$this->img["tinggi_thumb"] = $size;
        } else {
            $this->img["y"] = ceil(($this->img['tinggi']-$this->img['lebar'])/2);
            $this->img["tinggi"]=$this->img["lebar"];
			$this->img["lebar_thumb"]= $size;
            $this->img["tinggi_thumb"] = $size;
         }
    }
    ...
    function show()
    {
        ...
        $this->img["des"] = ImageCreateTrueColor($this->img["lebar_thumb"],$this->img["tinggi_thumb"]);
            @imagecopyresized ($this->img["des"], $this->img["src"], 0, 0, $this->img["x"], $this->img["y"], $this->img["lebar_thumb"], $this->img["tinggi_thumb"], $this->img["lebar"], $this->img["tinggi"]);
